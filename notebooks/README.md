...
| [`vecdb/`](./vecdb)                             | VecDB-focused notebooks for Oracle AI Database, including auto-embedding, BYOV, semantic search, indexing, bulk loading, OCI embeddings, Gemini RAG, parks search, and Private AI Services Container integration.                                                                             |
